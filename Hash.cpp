...
int main(){
	...
	read_file("terminales2.txt", terminales_txt);
...
void terminales_comprehension(){
	...
	for (int i = 0; i < terminales_txt.size(); i++){
		...
		add_terminal(codigo1, nombre1, ciudad1, pais1, stof(superficie1), stoi(cant_terminales), stoi(dest_nacionales), stoi(dest_internacionales));
	}
}
